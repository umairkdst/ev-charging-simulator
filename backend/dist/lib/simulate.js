...
exports.DEMAND_DIST = exports.ARRIVAL_PROB_BY_HOUR = void 0;
exports.simulate = simulate;
// T1: hourly arrival
exports.ARRIVAL_PROB_BY_HOUR = [
...
function getDemandProbability() {
    // helper function to sample demand
    const r = Math.random();
    let acc = 0;
    for (const { p, km } of exports.DEMAND_DIST) {
        acc += p / 100;
        if (r <= acc)
            return km;
    }
...
function simulate(inp) {
    ...
    for (let tick = 0; tick < TICKS_PER_YEAR; tick++) {
        ...
        const baseProb = exports.ARRIVAL_PROB_BY_HOUR[hourOfDay] / 100;
